...
architecture arch of BusController is
    ...
    constant BUS_ID_CIPHER               : std_logic_vector (3 downto 0) := "0001";
    constant BUS_ID_K_REG                : std_logic_vector (3 downto 0) := "0010";
    constant BUS_ID_Y_REG                : std_logic_vector (3 downto 0) := "0011";
    constant BUS_ID_TRANSMITTER          : std_logic_vector (3 downto 0) := "0101";
    constant BUS_ID_P_REG                : std_logic_vector (3 downto 0) := "0100";
    constant BUS_ID_RECEIVER             : std_logic_vector (3 downto 0) := "0110";
    ...
    constant global_FSM_S_RECEIVE_KEY    : std_logic_vector (3 downto 0) := "0101";
    constant global_FSM_S_CIPHER_P       : std_logic_vector (3 downto 0) := "0100";
    ...
    constant global_FSM_S_CIPHER_K       : std_logic_vector (3 downto 0) := "0010";
    constant global_FSM_S_XOR_P          : std_logic_vector (3 downto 0) := "1001";
    constant global_FSM_S_CIPHER_ENCRYPT : std_logic_vector (3 downto 0) := "0001";
    constant global_FSM_S_GENERATE_IV    : std_logic_vector (3 downto 0) := "0111";
    constant global_FSM_S_TRANSMIT_IV    : std_logic_vector (3 downto 0) := "0011";
    constant global_FSM_S_TRANSMIT_Y     : std_logic_vector (3 downto 0) := "1000";
...
begin
    ...
    bus_src(0) <= (is_S_GENERATE_IV and trng_available) or (is_S_XOR_Y) or (is_S_CIPHER_ENCRYPT and cipher_done) or (is_S_TRANSMIT_Y and transmitter_ready_for_data) or (is_S_TRANSMIT_IV and transmitter_ready_for_data);
    bus_src(1) <= (is_S_RECEIVE_KEY and receiver_available) or (is_S_GENERATE_IV and trng_available) or (is_S_RECEIVE_P and receiver_available) or (is_S_XOR_Y) or (is_S_CIPHER_K) or (is_S_TRANSMIT_Y and transmitter_ready_for_data) or (is_S_TRANSMIT_IV and transmitter_ready_for_data);
    bus_src(2) <= (is_S_RECEIVE_KEY and receiver_available) or (is_S_GENERATE_IV and trng_available) or (is_S_RECEIVE_P and receiver_available) or (is_S_XOR_P) or (is_S_CIPHER_P);
    bus_src(3) <= (is_S_XOR_STORE);
    bus_dst(0) <= (is_S_CIPHER_P) or (is_S_CIPHER_K) or (is_S_CIPHER_ENCRYPT and cipher_done) or (is_S_TRANSMIT_Y and transmitter_ready_for_data) or (is_S_TRANSMIT_IV and transmitter_ready_for_data) or (is_S_GENERATE_IV and trng_available);
    bus_dst(1) <= (is_S_RECEIVE_KEY and receiver_available) or (is_S_CIPHER_ENCRYPT and cipher_done) or (is_S_GENERATE_IV and trng_available);
    bus_dst(2) <= (is_S_RECEIVE_P and receiver_available) or (is_S_XOR_STORE) or (is_S_TRANSMIT_Y and transmitter_ready_for_data) or (is_S_TRANSMIT_IV and transmitter_ready_for_data);
