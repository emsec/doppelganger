...
entity Top is
    port (
        ...
        dummy_signals : out std_logic_vector (7 downto 0)
    );
end Top;
...
architecture arch of Top is
    ...
    constant global_BusController_BUS_ID_RECEIVER    : std_logic_vector (3 downto 0) := "0101";
    constant global_BusController_BUS_ID_TRANSMITTER : std_logic_vector (3 downto 0) := "0110";
    constant global_BusController_BUS_ID_Y_REG       : std_logic_vector (3 downto 0) := "0011";
    constant global_BusController_BUS_ID_K_REG       : std_logic_vector (3 downto 0) := "0100";
    constant global_BusController_BUS_ID_P_REG       : std_logic_vector (3 downto 0) := "0001";
    constant global_BusController_BUS_ID_TRNG        : std_logic_vector (3 downto 0) := "0111";
    constant global_BusController_BUS_ID_CIPHER      : std_logic_vector (3 downto 0) := "0010";
...
begin
    ...
    dummy_signals(3 downto 0) <= inst_fsm_dummy_signals;
    dummy_signals(7 downto 4) <= inst_bus_ctrl_dummy_signals;
